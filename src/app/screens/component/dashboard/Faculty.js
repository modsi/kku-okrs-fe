                ...
                fetchData && (
                    <div className='container-faculty'>
                        <div style={{ padding: '20px 15px 10px 15px' }}>
                            <span className="head-plots" style={{ margin: "10px 0px" }}>{title} </span>
                        </div>

                        <Row style={{ paddingBottom: '20px' }}>
                            <Col xs={24} sm={24} md={12} lg={12}>
                                <PieFull title={'สรุปจำนวนโครงการที่ดำเนินการแล้ว'} width={200} height={200} data={dataSummary} dataColor={['#f6c863', '#ef5261']} dataTextColor={['#A15219', '#45B649']} text={true} unit={'โครงการ'} />
                            </Col>
                        ...
                        <div style={{ padding: '20px 15px 10px 15px' }}>
                            <span className="head-plots" style={{ margin: "10px 0px" }}>SDGs (หลักสูตร)</span>
                        </div>
                        <Row style={{ paddingBottom: '20px' }}>
                            <Col xs={24} sm={24} md={12} lg={12}>
                                <PieFull title={'สรุปจำนวนโครงการตาม SDGs'} width={200} height={200} data={dataSDGs} dataColor={['#f6c863', '#ef5261']} dataTextColor={['#A15219', '#45B649']} text={true} unit={'รายการ'} />
                            </Col>
                            <Col xs={0} sm={0} md={1} lg={1}></Col>
                            <Col xs={24} sm={24} md={11} lg={11} className="box-plan">
                        ...
                        <div style={{ padding: '20px 15px 10px 15px' }}>
                            <span className="head-plots" style={{ margin: "10px 0px" }}>21 Century Skill (หลักสูตร) </span>
                        </div>
                        <Row style={{ paddingBottom: '20px' }}>
                            <Col xs={24} sm={24} md={12} lg={12}>
